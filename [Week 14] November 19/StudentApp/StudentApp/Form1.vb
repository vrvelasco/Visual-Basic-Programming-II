Public Class Form1
    ...
    Private Sub DisplayStudent()
        ...
        Dim fulltime = students.
            Where(Function(s) s.CurrentCredits >= 12).
            Select(Function(s) s.StudentFullName)
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        Dim match = students.
            Where(Function(s) s.StudentLastName.ToLower().Contains(txtName.Text.ToLower()))
    ...
    Private Sub lstResults_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstResults.SelectedIndexChanged
        ...
        Dim match = students.
            Where(Function(s) s.StudentFullName = lstResults.Text())
