...
Public Class CommissionEmployee
    Inherits Object ' Not needed; everything inherits from Object
    ...
    ' Protected is available to Class and derived classes
    Protected grossSalesValue As Decimal ' gross weekly sales             
    Protected commissionRateValue As Double ' commission percentage       
