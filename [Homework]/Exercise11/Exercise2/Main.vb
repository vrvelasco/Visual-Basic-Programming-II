Public Class Main
    ...
    Private Sub DisplayEmp()
        If bsEmployees.Current IsNot Nothing Then
            ...
            lblTotalMonthly.Text = employees.Select(Function(m) m.MonthlySalary).Sum().ToString("C")
            lblTotalAnnual.Text = employees.Select(Function(m) m.AnnualSalary).Sum().ToString("C")
        End If
    End Sub
    ...
    Private Sub TxtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        Dim match = employees.Where(Function(s) s.Name.ToLower().StartsWith(txtSearch.Text().ToLower()))
    ...
    Private Sub LstResults_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstResults.SelectedIndexChanged
        Dim match = employees.Where(Function(r) r.Name = lstResults.Text())
        'From emp In employees
        'Where emp.Name = lstResults.Text()
